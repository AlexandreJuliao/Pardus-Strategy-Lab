    ...
    <section className="relative overflow-hidden text-text-primary">
      ...
      <div className="shell relative z-10 grid grid-cols-1 gap-10 py-20 md:py-28 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
        <div>
          ...
          <p className="mt-5 max-w-md font-sans text-[clamp(15px,1.4vw,18px)] leading-relaxed text-[#c8d4e6]">
            {x.intro}
          </p>
          <a
          ...
          {x.items.map((it, i) => {
            ...
            return (
              <Reveal
                ...
                key={it.title}
                delay={i * 0.09}
                className="flex items-start gap-4 border-t border-white/[0.12] py-5"
              >
